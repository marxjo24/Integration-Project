...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println("Enter the number of periods as a whole number, then enter the number of years as a whole number");
    System.out.println("The coumpound interest is: $" 
    + fakeBank1.getInterestOvertime(fakeBank1.getBankBalance(), Bank.getInterest(), scan.nextInt(), scan.nextInt()));
