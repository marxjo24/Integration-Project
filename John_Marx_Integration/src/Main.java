...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Enter an interger to be divided by " + num2);
    ...
    System.out.println(
        "The coumpound interest is: $" + fakeBank1.getInterestOvertime(fakeBank1.getBankBalance(),
    ...
    System.out.println("The 1st restuarant name is " + Restaurant.returnName(restaurant1));
    ...
    System.out.println("Ryan's dialauge is:  " + customer1.speak());
    System.out.println("Sherri's dialauge is:  " + customer2.speak());
